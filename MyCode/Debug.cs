...
namespace Com.CodeGame.CodeRacing2015.DevKit.CSharpCgdk {
	...
	public struct Debug {
        ...
        private static string encodeColor(int color)
        {
            ...
            return String.Format("{0} {1} {2}", ((double)red / 256.0).ToString(Nfi), ((double)green / 256.0).ToString(Nfi), ((double)blue / 256.0).ToString(Nfi));
        }
		...
		public static void circleFill(double x, double y, double radius, int color) {
